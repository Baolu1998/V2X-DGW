...
# hypes_yaml='/home/baoluli/1.code/4.Adverseweather/V2V_baolu/opencood/hypes_yaml/opv2v_DG/point_pillar_intermediate_fusion.yaml'
# CUDA_VISIBLE_DEVICES=7 python3 /home/baoluli/1.code/4.Adverseweather/V2V_baolu/opencood/tools/train_DG.py --hypes_yaml $hypes_yaml #--model_dir $model 

# hypes_yaml='/home/baoluli/1.code/4.Adverseweather/V2V_baolu/opencood/hypes_yaml/v2xset_DG/point_pillar_intermediate_fusion.yaml'
# CUDA_VISIBLE_DEVICES=7 python3 /home/baoluli/1.code/4.Adverseweather/V2V_baolu/opencood/tools/train_DG.py --hypes_yaml $hypes_yaml #--model_dir $model 

hypes_yaml='/home/baoluli/1.code/4.Adverseweather/V2V_baolu/opencood/hypes_yaml/opv2v_DG/point_pillar_cobevt.yaml'
CUDA_VISIBLE_DEVICES=1 python3 /home/baoluli/1.code/4.Adverseweather/V2V_baolu/opencood/tools/train_DG_other_ffn.py --hypes_yaml $hypes_yaml #--model_dir $model