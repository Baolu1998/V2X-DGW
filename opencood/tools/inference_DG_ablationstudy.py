...
# def test_parser():
#     parser = argparse.ArgumentParser(description="synthetic data generation")
#     parser.add_argument('--model_dir', type=str,default='/home/baoluli/personal/2.model_saved/4.Adverseweather/ablation_study/base', #required=True,# 
#                         help='Continued training path')
...
def main():
    ...
    if hypes['DG_params']['Is_DG']:
        ...
        for idx in range(hypes['DG_params']['DG_validate_num']):
            ...
            result_stat = result_stat_DGs[idx]
