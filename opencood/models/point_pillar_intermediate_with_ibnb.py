...
from opencood.models.sub_modules.att_bev_backbone_with_ibnb import AttBEVBackbone
...
class PointPillarIntermediatewithIBNB(nn.Module):
    def __init__(self, args):
        super(PointPillarIntermediatewithIBNB, self).__init__()
