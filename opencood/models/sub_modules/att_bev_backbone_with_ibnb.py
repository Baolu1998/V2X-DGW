...
class AttBEVBackbone(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        for idx in range(num_levels):
            cur_layers = [
                ...
                nn.ReLU(),
                nn.InstanceNorm2d(num_filters[idx], eps=1e-3)
            ]
    ...
    def forward(self, data_dict):
        ...
        data_dict['before_fusion_features'] = before_fusion_features
        return data_dict
